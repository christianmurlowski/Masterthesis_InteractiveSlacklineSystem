...
The following chapter discusses the implementation of an interactive slackline learning system with real-time feedback regarding the conceptual elaboration.
...
Each exercise has to be created by the developer such that the SLS can match and compare the movement performance of a trainee with the actual exercise. 
...
After that, section \textit{\nameref{5_3_systemArchitecture}} explains the general relationship of several system components, which includes for example the interplay of the Kinect SDK with  Unity3D as game engine, and more specific topics like e.g. real-time feedback integration.
