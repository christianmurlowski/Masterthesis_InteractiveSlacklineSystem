...
Lastly section \textit{\nameref{5_4_software}} explains the relationship between the Kinect SDK and Unity3D as game engine.
Furthermore, each component of the application is visualized on a top-down workflow through the user interface.
