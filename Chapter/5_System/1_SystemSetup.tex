...
\begin{figure}[htb]
	...
	\begin{minipage}[t]{1\linewidth}
		...
		\caption{System overview \todo{evtl. bild vom setup}}
...
Additionally the Kinect is in a position that won't disturb the visual sense of the slacker during her training on the slackline, e.g. by setting a focus point in front of her. \todo{sprachlich nicht so gut verständlich?}
