...
\begin{figure}[htb]
	...
	\begin{minipage}[t]{0.44\linewidth}
		...
		\subcaption{Highline between mountains~\cite{WikiSlacklining2017-highline}}
		\label{fig:highline}
	\end{minipage}
...
\begin{figure}[htb]
	...
	\begin{minipage}[t]{0.45\linewidth}
		...
		\subcaption{Slacker walking on a rodeoline in Graz~\cite{WikiSlacklining2017-rodeoline}}
		\label{fig:rodeoline}
	\end{minipage}
	\hfill
	\begin{minipage}[t]{0.45\linewidth}
		...
		\subcaption{Alexander Schulz on a 340 m longline~\cite{WikiSlacklining2017-longline}}
		\label{fig:longline}
	\end{minipage}
...
\begin{figure}[htb]
	...
	\begin{minipage}[t]{0.45\linewidth}
		...
		\subcaption{Waterlining over the Sulm in Austria~\cite{WikiSlacklining2017-waterline}}
		\label{fig:waterline}
	\end{minipage}
	\hfill
	\begin{minipage}[t]{0.45\linewidth}
		...
		\subcaption{Urbanlining in Rillieux-la-Pape~\cite{WikiSlacklining2017-urbanline}}
		\label{fig:urbanline}
	\end{minipage}
