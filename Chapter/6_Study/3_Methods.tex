...
\todo{------------------------------------------------------- insert mobile slackline device}

Like seen in section \textit{\nameref{3_2_slacklineVariations}} a mobile slackline device is the best solution for the learning system. This makes it easy to vary its position and rotate it accordingly. 
