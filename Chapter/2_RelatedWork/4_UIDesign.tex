...
\begin{figure}[htb]
	...
	\begin{minipage}[t]{0.40\linewidth}
		\centering
		\includegraphics[width=1\linewidth]{Pictures/informationUISurroundingObjects2}
	...
	\begin{minipage}[t]{0.40\linewidth}
		\centering
		\includegraphics[width=1\linewidth]{Pictures/informationUIFeedbackSummary2}
...
\begin{figure}[htb]
	...
	\begin{minipage}[t]{0.49\linewidth}
		\centering
		\includegraphics[width=0.7\linewidth]{Pictures/hciGuidelinesFeedbackCursor}
	...
	\begin{minipage}[t]{0.49\linewidth}
		\centering
		\includegraphics[width=0.7\linewidth]{Pictures/hciGuidelinesFeedbackControl}
...
This zone ensures that the user is able to reach anything in a comfortable range. In the application it is constrained by the joints of the shoulders to the hips of the opposite site of the interaction hand. It is designed to have a better understanding, like seen in figure \ref{fig:higPHIZ}.
\begin{figure}[htb]
	\centering
	\begin{minipage}[t]{1\linewidth}
		\centering
